...
This repository contains the source code for my MSc Data Science dissertation:
...
- `data-acquisition/` - R Script used to obtain and prepare source data.
- `analysis/` - Statistical analysis script (R), preprocessing and machine learning code.
- `web/` - Source code for the web-based MPI prediction application.
- `web/plumber/` - R Plumber prediction API.
